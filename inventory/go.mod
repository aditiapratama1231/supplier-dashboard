module qasir-supplier/inventory
...
require (
	...
	github.com/gobuffalo/pop v4.11.2+incompatible // indirect
	...
	github.com/ru-rocker/gokit-playground v0.0.0-20171224044615-d5bb41590321
